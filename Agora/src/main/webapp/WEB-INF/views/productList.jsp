...
<div class="transbox center">
	...
	<c:forEach  var="p" items="${displayAll}">
		...
		<div class="row container smaller">	
			...
			<div class="col-md-8 d-flex align-items-center"><p>${p.description}</p></div>
			<div class="col-md-2 d-flex align-items-center"><img class ="center" src="${p.productImgUrl}"></div>		
		</div>
